      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-4">
            Meskipun Cicurug-9 adalah rayon yang termasuk baru, generasi yang mulai turun termurun ini siap untuk terus!!
          </p>
          <div className="mb-8">
...
function TextRevealCardPreview() {
  return (
    <div className="flex items-center justify-center bg-[#0E0E10] h-[40rem] rounded-2xl w-full">
      <TextRevealCard
        text="The Galery, a silent.."
        revealText="a Silent Memory"
      >
        <TextRevealCardTitle>
        Second by second, painted in frames.
        </TextRevealCardTitle>
        <TextRevealCardDescription>
